...
<body class="body-scroll" data-page="sendmoney1">
    ...
    <main class="h-100">
        ...
        <header class="header position-fixed">
            <div class="row">
                <div class="col-auto">
                    <button class="btn btn-light btn-44 back-btn" onclick="window.location.replace('sendmoney');">
        ...
        <div class="main-container container">
            ...
            <div class="row mb-4">
                ...
                <div class="col-auto">
                    <button class="btn btn-default btn-44 shadow-sm" onclick="window.location.replace('sendmoney');">
