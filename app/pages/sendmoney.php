...
<body class="body-scroll" data-page="sendmoney">
        ...
        <div class="main-container container">
            ...
            <div class="row mb-4">
                <div class="col-12 text-center">
                    <img src="../assets/img/infographic-send.png" alt="">
                </div>
            </div>

            <div class="row">
                <div class="col-12 text-center mb-4">
                    <h1 class="mb-3 text-color-theme">Send Money</h1>
                    <p class="text-muted">Now you can send money to FiMobile user as well as your mobile contact list
                        member. Contact has to go through sort process.</p>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="form-group form-floating is-valid mb-1">
                        <input type="text" class="form-control " id="contact" placeholder="Contact" value="Maxartkiller">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <button class="btn btn-default btn-44 shadow-sm" onclick="window.location.replace('sendmoney2');">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <button class="btn btn-default btn-44 shadow-sm" onclick="window.location.replace('sendmoney1');">
                                        <i class="bi bi-arrow-up-right-circle"></i>
                                    </button>
                                </div>
                            </div>
            ...
            <div class="row mb-3">
                <div class="col">
                    <h6 class="title">FiMobile Contacts</h6>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-12 px-0">
