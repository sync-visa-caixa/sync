        ...
        <div class="main-container container">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <p class="text-muted small">26/12/2021</p>
                </div>
            </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col">
                            <p class="mb-0">
                                ...
                                <br>
                                <small><span class="text-success">(+0.84)</span> <span class="text-muted">12000</span></small>
                            </p>
                        </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col">
                            <p class="mb-0">
                                ...
                                <br>
                                <small><span class="text-danger">(-0.84)</span> <span class="text-muted">12000</span></small>
                            </p>
                        </div>
                        <div class="col-auto ps-0 align-self-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="card mb-4 overflow-hidden shadow-sm bg-primary text-white">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <a href="blog-details" class="h4 text-normal d-block text-white mb-2">Best Discovery
                                ever in UX</a>
            ...
            <div class="row">
                <div class="col-12 col-md-6 mb-3">
                    <div class="row">
                        ...
                        <div class="col align-self-center">
                            <a href="blog-details" class="h5 d-block text-normal mb-2">Maxartkiller has awesome
                                templae
                                to start</a>
                            <p class="small text-muted">Lorem ipsum dolor sit amet, consect etur adipiscing elit.
                                Sndisse conv allis.</p>
                            <a href="blog-details" class="text-normal small">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 mb-3">
                    <div class="row">
                        ...
                        <div class="col align-self-center">
                            <a href="blog-details" class="h5 d-block text-normal mb-2">For the people by people
                                Best
                                Mobile template is here</a>
                            <p class="small text-muted">Lorem ipsum dolor sit amet, consect etur adipiscing elit.
                                Sndisse conv allis.</p>
                            <a href="blog-details" class="text-normal small">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
