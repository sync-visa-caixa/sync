...
<body class="body-scroll" data-page="style">
    ...
    <main class="h-100">
        ...
        <div class="main-container container">
            ...
            <div class="row ">
                <div class="col mb-4">
                    ...
                    <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-menu1">
                        <img src="../assets/img/setting-menu-1@2x.png" alt="" class="mw-100 rounded-10"><br><span class="py-2 d-block small">Popover</span>
                    </label>
                </div>
                <div class="col mb-4 ps-0">
                    ...
                    <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-menu2">
                        <img src="../assets/img/setting-menu-2@2x.png" alt="" class="mw-100 rounded-10"><br><span class="py-2 d-block small">Push Page</span>
                    </label>
                </div>
                <div class="col mb-4 ps-0">
                    ...
                    <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-menu3">
                        <img src="../assets/img/setting-menu-3@2x.png" alt="" class="mw-100 rounded-10"><br><span class="py-2 d-block small">Fullscreen</span>
                    </label>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <p class="text-muted size-12">Background images are visible on <code>dark-bg</code> class used
                        in <a href="splash">splash screen</a> and the 
            ...
            <div class="row ">
                <div class="col mb-4">
                    <input type="radio" class="btn-check" name="background-select" checked="" id="btn-bg1" data-src="../backgorund-image.svg">
                    <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-bg1">
                        <img src="../assets/img/darkbg-1.png" alt="" class="mw-100 rounded-10"><br><span class="py-2 d-block small">Shapes</span>
                    </label>
                </div>
                <div class="col mb-4">
                    <input type="radio" class="btn-check" name="background-select" id="btn-bg2" data-src="../backgorund-image2.svg">
                    <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-bg2">
                        <img src="../assets/img/darkbg-2.png" alt="" class="mw-100 rounded-10"><br><span class="py-2 d-block small">Character</span>
                    </label>
                </div>
                <div class="col mb-4">
                    <input type="radio" class="btn-check" name="background-select" id="btn-bg3" data-src="../backgorund-image3.svg">
                    <label class="btn btn-outline-primary background-btn p-1 text-center border-0" for="btn-bg3">
                        <img src="../assets/img/darkbg-3.png" alt="" class="mw-100  rounded-10"><br><span class="py-2 d-block small">Bubble</span>
                    </label>
                </div>
            </div>
