...
<body class="body-scroll">
    ...
    <main class="h-100 has-header">
        ...
        <div class="main-container container">
                ...
                <br>
                <h6>What personal data we collect and why we collect it</h6>
                <h6>Comments</h6>
                ...
                <h6>Media</h6>
                <p>If you upload images to the website, you should avoid uploading images with embedded location data (EXIF
                ...
                <p>If you leave a comment on our site you may opt-in to saving your name, email address and website in
                    ...
                    leave another comment. These cookies will last for one year.</p>
                <p>If you have an account and you log in to this site, we will set a temporary cookie to determine if your
                ...
                <p>Articles on this site may include embedded content (e.g. videos, images, articles, etc.). Embedded
                ...
                <p>You can request that we erase any personal data we hold about you. This does not include any data we are
                    obliged to keep for administrative, legal, or security purposes.</p>
                <br>
